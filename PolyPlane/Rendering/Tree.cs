...
namespace PolyPlane.Rendering
{
    ...
    public class NormalTree : Tree
    {
        ...
        public override void Render(RenderContext ctx, D2DColor timeOfDayColor, float scale)
        {
            ...
            Utilities.ApplyTranslation(trunk, trunkTrans, 0f, this.Position + shadowPosOffset, scale);
            ...
            // Draw tree.
            Utilities.ApplyTranslation(trunk, trunkTrans, 180f, this.Position, scale);
    ...
    public class PineTree : Tree
    {
        ...
        public override void Render(RenderContext ctx, D2DColor timeOfDayColor, float scale)
        {
            var pineTop = new D2DPoint[]
         {
            ...
            ctx.Gfx.RotateTransform(shadowAngle, this.Position);
            ctx.Gfx.ScaleTransform(1f, 2f, this.Position);
            Utilities.ApplyTranslation(pineTop, pineTopTrans, 0f, shadowTopPos, scale);
            ...
            // Draw tree.
            Utilities.ApplyTranslation(pineTop, pineTopTrans, 180f, this.Position - new D2DPoint(0, this.Height), scale);
