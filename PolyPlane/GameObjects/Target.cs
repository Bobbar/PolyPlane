...
namespace PolyPlane.GameObjects
{
    public abstract class Target : GameObjectPoly
    {
        ...
        public int PolyRadius { get; set; } = 6;//10;//80;

        protected readonly float MIN_MAX_VELO = 200f;//250f;//150f;
        protected readonly float MIN_MAX_ROT = 10f; //40f;
    ...
    public class StaticTarget : Target
    {
        ...
        {
            ctx.DrawPolygon(this.Polygon.Poly, D2DColor.White, 1f, D2DDashStyle.Solid, D2DColor.DeepPink);
        }
    }
    ...
    public class LinearMovingTarget : Target
    {
        ...
        public override void Render(RenderContext ctx)
        {
            ctx.DrawPolygon(this.Polygon.Poly, D2DColor.White, 1f, D2DDashStyle.Solid, D2DColor.White);
        }
    }
    ...
    public class RotatingMovingTarget : Target
    {
        ...
        public override void Render(RenderContext ctx)
        {
            ctx.DrawPolygon(this.Polygon.Poly, D2DColor.White, 1f, D2DDashStyle.Solid, D2DColor.BlueViolet);
        }
    ...
    public class ErraticMovingTarget : Target
    {
        ...
        public override void Render(RenderContext ctx)
        {
            ctx.DrawPolygon(this.Polygon.Poly, D2DColor.White, 1f, D2DDashStyle.Solid, D2DColor.OrangeRed);
        }
