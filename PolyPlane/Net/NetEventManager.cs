...
namespace PolyPlane.Net
{
    public class NetEventManager : IImpactEvent, IPlayerScoredEvent
    {
        ...
        {
            var syncPacket = new SyncPacket(World.CurrentNetTimeMs(), World.TimeOfDay, World.TimeOfDayDir, World.GunsOnly, World.IsPaused, World.TargetDT);
